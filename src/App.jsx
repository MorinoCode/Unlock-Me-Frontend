...
const InitialQuizzesQuestionsPage = lazy(() => import('./pages/initialQuizzesQuestionsPage/InitialQuizzesQuestionsPage'));
const ExplorePage = lazy(() => import('./pages/explorePage/ExplorePage'));
const ViewAllMatchedExploreUsersPage = lazy(() => import('./pages/viewAllMatchedExploreUsersPage/ViewAllMatchedExploreUsersPage'));
...
const ViewAllMatchesPage = lazy(() => import('./pages/viewAllMatchesPage/ViewAllMatchesPage'));
const MessagesPage = lazy(() => import('./pages/MessagesInboxPage/MessagesInboxPage'));
